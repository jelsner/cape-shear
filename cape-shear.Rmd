...
=======
         ...
         HLCY_avg = avgHLCY/10)
>>>>>>> 29ebf6d5c3ab0fed038545b30999cd34538ad6bb
dim(BigDays.sfdfT)
```
...
modelInitial <- glm.nb(nT ~ A + Lat + Lon + Year + CAPE + CIN + DLBS + SLBS +SRH + LCL, data = BigDays.sfdfT)

modelInitial <- glm.nb(nT ~ A + Lat + Lon + Year + CAPE + CIN + DLBS + SLBS + HLCY, data = BigDays.sfdfT)

summary(modelInitial)

modelInitialPoisson <- glm(nT ~ A + Lat + Lon + CAPE + CIN + DLBS + SLBS + SRH, family = "poisson", data = BigDays.sfdfT)
