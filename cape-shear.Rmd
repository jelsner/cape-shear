...
Start with area and all seven environmental variables.
```{r}
modelglm.nb <- glm.nb(nT ~ scale(HullArea) + scale(minCIN) + scale(maxVSTM) + scale(maxUSTM) + scale(maxBS_deep) + scale(maxBS_shallow) + scale(maxHLCY) + scale(maxCAPE), data = BigDays.sfdfT)
summary(modelglm.nb)

modelglm.nb <- glm.nb(nT ~ scale(HullArea) + scale(maxVSTM) + scale(maxUSTM) + scale(maxBS_deep) + scale(maxBS_shallow) + scale(maxHLCY) + scale(maxCAPE), data = BigDays.sfdfT)
summary(modelglm.nb)

modelglm.nb <- glm.nb(nT ~ scale(HullArea) + scale(maxVSTM) + scale(maxUSTM) + scale(maxBS_deep) + scale(maxHLCY) + scale(maxCAPE), data = BigDays.sfdfT)
summary(modelglm.nb)

modelglm.nb <- glm.nb(nT ~ scale(HullArea) + scale(maxVSTM) + scale(maxBS_deep) + scale(maxHLCY) + scale(maxCAPE), data = BigDays.sfdfT)
summary(modelglm.nb)

modelglm.nb <- glm.nb(nT ~ scale(HullArea) + scale(maxVSTM) + scale(maxBS_deep) * scale(maxCAPE) + scale(maxHLCY), data = BigDays.sfdfT)
summary(modelglm.nb)
```
