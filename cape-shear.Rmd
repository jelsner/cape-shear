...
modelglmer.nb <- glmer.nb(nT ~ scale(HullArea) + scale(maxCAPE) * scale(maxBS_deep) + scale(maxBS_shallow)  + (1|Mo), data = BigDays.sfdfT)
summary(modelglmer.nb)
modelglm.nb <- glm.nb(nT ~ scale(HullArea) + scale(maxCAPE) * scale(maxBS_deep) + scale(maxBS_shallow), data = BigDays.sfdfT)
summary(modelglm.nb)


modelglmer.nb <- glmer.nb(GroupDayCas ~ scale(totalPOP) + scale(maxCAPE) + scale(maxBS_deep) + scale(maxBS_shallow) + (1|Mo), data = BigDays.sfdfT)
summary(modelglmer.nb)
modelglm.nb <- glm.nb(GroupDayCas ~ scale(totalPOP) + scale(maxCAPE) + scale(maxBS_deep) + scale(maxBS_shallow), data = BigDays.sfdfT)
summary(modelglm.nb)
