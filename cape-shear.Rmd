...
TCount[i] <- predict(glm.nb(nT ~ A + CAPE + DLBS + SLBS, data = BigDays.sfdfT[-i, ]), 
                       newdata = BigDays.sfdfT[i,],
                       type = "response")
CCount[i] <- predict(glm.nb(GroupDayCas ~ P + Lat + Lon + Year + CAPE + DLBS + SLBS, data = BigDays.sfdfT[-i, ]), 
                       newdata = BigDays.sfdfT[i,],
                       type = "response")
}
